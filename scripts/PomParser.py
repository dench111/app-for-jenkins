...
request = 'curl -XPOST -v -u $USERNAME:$PASSWORD --upload-file "/var/jenkins_home/workspace/target/$appNameold.jar" "http://192.168.0.84:8081/nexus/content/repositories/Testrep/$FPname.jar"'
